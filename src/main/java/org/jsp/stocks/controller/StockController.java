...
import org.jsp.stocks.service.EmailService;
import org.jsp.stocks.service.StockHistoryService;
...
public class StockController {
	...
	public String testMail() {
		emailService.sendEmail("supritasg05@gmail.com", "Test Email from Stock App", 
			"Congratulations! Your email configuration is working perfectly!");
		return "✅ Test email sent! Check your inbox.";
	}
	
	// ========== NEW CODE FOR STOCK HISTORY CHART ==========
	
	// API endpoint to get stock history as JSON (for the chart)
	@GetMapping("/stock-history/{ticker}")
	@ResponseBody
	public List<Map<String, Object>> getStockHistory(@PathVariable String ticker) {
		return stockHistoryService.getLast7DaysHistory(ticker);
	}
	
	// New Buy Stock page with chart
	@GetMapping("/buy-stock-chart/{ticker}")
	public String showBuyWithChart(@PathVariable String ticker, Model model, HttpSession session) {
